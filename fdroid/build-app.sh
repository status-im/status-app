...
# nimble is the only prerequisite: `nimble setup` resolves the graph and
# materialises the pinned Nim compiler in nimble's store; the mobile make legs
# find it there with `nimble path nim`, nothing is sourced.
nimble setup
