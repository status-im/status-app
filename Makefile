...
$(NIM_STATUS_CLIENT): $(NIM_SOURCES) | statusq dotherside check-qt-dir $(STATUSGO) $(NIMSDS_LIBFILE) $(STATUSKEYCARD_QT_LIB) rcc deps $(NIMBLE_SETUP_STAMP)
	echo -e $(BUILD_MSG) "$@"
...
nim-test-run/%: | qt-pkgconfig dotherside $(STATUSGO) $(NIMBLE_SETUP_STAMP)
