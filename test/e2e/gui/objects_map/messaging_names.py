...
chatMessageViewDelegate_editMessageInput_StatusChatInputNew = {"container": chatLogView_chatMessageViewDelegate_MessageView, "objectName": "editMessageInput", "type": "StatusChatInputNew", "visible": True}
editMessageInput_messageInputField = {"container": chatMessageViewDelegate_editMessageInput_StatusChatInputNew, "objectName": "messageInputField", "type": "TextArea", "visible": True}
editMessageInput_statusChatInputEditAcceptButton = {"container": chatMessageViewDelegate_editMessageInput_StatusChatInputNew, "objectName": "statusChatInputEditAcceptButton", "type": "StatusRoundButton", "visible": True}
