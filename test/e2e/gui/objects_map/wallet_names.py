...
asset_details_view = {"container": mainWindow_RightTabView, "type": "AssetsDetailView", "visible": True}
...
asset_details_scroll_view = {"container": mainWindow_RightTabView, "id": "scrollView", "type": "StatusScrollView", "unnamed": 1, "visible": True}
asset_details_chart_panel = {"container": mainWindow_RightTabView, "id": "graphDetail", "type": "StatusChartPanel", "unnamed": 1, "visible": True}
asset_details_chart_canvas = {"container": asset_details_scroll_view, "id": "graphComponent", "type": "ChartCanvas", "unnamed": 1, "visible": True}
asset_details_time_range_tab_bar = {"container": mainWindow_RightTabView, "id": "timeRangeTabBar", "type": "StatusTabBar", "unnamed": 1, "visible": True}
asset_details_chart_range_1y = {"checkable": True, "container": asset_details_time_range_tab_bar, "text": "1Y", "type": "StatusTabButton", "unnamed": 1, "visible": True}
asset_details_graph_loading = {"container": asset_details_scroll_view, "type": "LoadingGraphView", "unnamed": 1, "visible": True}
