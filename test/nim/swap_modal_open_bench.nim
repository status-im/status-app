...
## GREEN (the target the fix must hold): open_typed_handoff @10k <= 32ms.
##
...
# Faithful replica of the string-envelope decode target the production slot uses
# (BuildGroupsForChainResponse in async_tasks.nim): same DTO seq, same decode cost.
