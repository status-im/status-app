...
Item {
    ...
    AssetsDetailsHeader {
        ...
        secondaryText: tokenGroup && tokenGroup.balanceText ? tokenGroup.balanceText : Constants.dummyText
        tertiaryText: {
                ...
                GridLayout {
                    ...
                    InformationTileAssetDetails {
                        ...
                        content: InformationTag {
                            asset.name : "browser"
                            tagPrimaryLabel.text: tokenGroup && tokenGroup.websiteUrl ? SQUtils.Utils.stripHttpsAndwwwFromUrl(tokenGroup.websiteUrl) : ""
