...
QtObject {
    ...
    readonly property var ownerTokenDetails: {
        if (!communityTokensModuleInst || !communityTokensModuleInst.ownerTokenDetails)
            return {}
        try { return JSON.parse(communityTokensModuleInst.ownerTokenDetails) } catch(e) { return {} }
    }
