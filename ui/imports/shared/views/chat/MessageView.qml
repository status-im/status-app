                ...
                statusChatInput: Component {
                    StatusChatInput {
                        ...
                        Component.onCompleted: {
                            ...
                            //
                            // Load the raw unparsed text into the editor, resolving its textual
                            // "@0x…"/"@0x00001" mentions to pills via the same map used for
                            // rendering (ChatTextArea.loadText).
                            editTextInput.textInput.loadText(root.unparsedText, root.mentionsMap)
                            delegate.originalMessageText = editTextInput.textInput.textWithMentions()
                        }
                    }
                }
