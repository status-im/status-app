...
QtObject {
    ...
    signal openContactRequestPopupWithDefaultMessage(string publicKey, var cb, string defaultMessage)
    ...
    signal signingResult(string reason, string signature, string keyUid, string path, string address) // in case of canceling the flow, or any error, signature param is empty
    ///////////////////////////////////////////////////////////////
