...
const BASE_NAME_LIFI_API_KEY = "LIFI_API_KEY"
const BASE_NAME_RELAY_API_KEY = "RELAY_API_KEY"
const BASE_NAME_KLIPY_API_KEY = "KLIPY_API_KEY"
...
const BASE_NAME_ETH_RPC_PROXY_USE_PUZZLE_AUTH = "ETH_RPC_PROXY_USE_PUZZLE_AUTH"
...
const BUILD_LIFI_API_KEY = getEnv(BUILD_TIME_PREFIX & BASE_NAME_LIFI_API_KEY)
const BUILD_RELAY_API_KEY = getEnv(BUILD_TIME_PREFIX & BASE_NAME_RELAY_API_KEY)
...
const BUILD_ETH_RPC_PROXY_USE_PUZZLE_AUTH = getEnv(BUILD_TIME_PREFIX & BASE_NAME_ETH_RPC_PROXY_USE_PUZZLE_AUTH, "true") == "true"
...
const
  DEFAULT_KLIPY_API_KEY = ""
  BUILD_KLIPY_API_KEY = getEnv(BUILD_TIME_PREFIX & BASE_NAME_KLIPY_API_KEY, DEFAULT_KLIPY_API_KEY)
...
type StatusDesktopConfig = object
  ...
  lifiApiKey* {.
    defaultValue: BUILD_LIFI_API_KEY
    desc: "Sets LiFi api key"
    name: $BASE_NAME_LIFI_API_KEY
    abbr: "lifi-api-key" .}: string
  relayApiKey* {.
    defaultValue: BUILD_RELAY_API_KEY
    desc: "Sets Relay api key"
    name: $BASE_NAME_RELAY_API_KEY
    abbr: "relay-api-key" .}: string
  klipyApiKey* {.
    defaultValue: BUILD_KLIPY_API_KEY
    desc: "Sets klipy api key"
    name: $BASE_NAME_KLIPY_API_KEY
    abbr: "klipy-api-key" .}: string
  ...
  ethRpcProxyUsePuzzleAuth* {.
    defaultValue: BUILD_ETH_RPC_PROXY_USE_PUZZLE_AUTH
    desc: "Enables puzzle authentication for eth-rpc smart proxy"
    name: $BASE_NAME_ETH_RPC_PROXY_USE_PUZZLE_AUTH
    abbr: "eth-rpc-proxy-use-puzzle-auth" .}: bool
  nftProxyUrl* {.
