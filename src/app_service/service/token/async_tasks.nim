...
type
  ...
  # The old string-envelope types for the two heavy tasks were removed: those tasks
  # now build the finished structures on the worker and hand them over typed via
  # finishTyped (see token_apply_builder + asyncRefreshTokensTask /
  # asyncFetchAllTokenListsTask).
