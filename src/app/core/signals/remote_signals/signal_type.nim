...
type SignalType* {.pure.} = enum
  ...
  WalletTokenBalancesFetchStarted = "wallet.token-balances.fetch-started"
  WalletTokenBalancesFetchFailedToStart = "wallet.token-balances.fetch-failed-to-start"
  WalletTokenBalancesFetchFinished = "wallet.token-balances.fetch-finished"
  WalletTokenBalancesFetchError = "wallet.token-balances.fetch-error"
