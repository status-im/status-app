...
type SignalType* {.pure.} = enum
  ...
  CuratedCommunitiesRefreshStarted = "curated.communities.refresh.started"
  CuratedCommunityResolved = "curated.communities.refresh.communityResolved"
  CuratedCommunitiesRefreshFinished = "curated.communities.refresh.finished"
