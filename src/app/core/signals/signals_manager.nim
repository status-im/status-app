...
QtObject:
  ...
  proc decode(self: SignalsManager, jsonSignal: JsonNode): Signal =
    ...
    result = case signalType:
      ...
      of SignalType.CuratedCommunitiesRefreshStarted: Signal(signalType: SignalType.CuratedCommunitiesRefreshStarted)
      of SignalType.CuratedCommunityResolved: CuratedCommunityResolvedSignal.fromEvent(jsonSignal)
      of SignalType.CuratedCommunitiesRefreshFinished: CuratedCommunitiesRefreshFinishedSignal.fromEvent(jsonSignal)
