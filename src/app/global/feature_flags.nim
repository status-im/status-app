...
const DEFAULT_FLAG_STATUS_SUPPORT_BOT_ENABLED = false
...
QtObject:
  ...
  proc getStatusSupportBotEnabled*(self: FeatureFlags): bool {.slot.} =
    return self.statusSupportBotEnabled

  QtProperty[bool] statusSupportBotEnabled:
    read = getStatusSupportBotEnabled
