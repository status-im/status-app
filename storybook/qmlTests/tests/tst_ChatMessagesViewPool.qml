...
/*
 Dressed-window gate (issue 0005): with a row pool attached, the message
...
Item {
    ...
    TestCase {
        ...
        // Chat switch (issue 0006): the shared view swaps models — the old
        ...
        // ---- Window record (issue 0007): capture/restore of the viewing
