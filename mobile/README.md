...
- All required tools and dependencies (Qt 6.11.0, Android SDK/NDK, Go, nimble) are provided by the container; the Nim compiler itself is fetched by `make update` from the pin in `nim_status_client.nimble`
