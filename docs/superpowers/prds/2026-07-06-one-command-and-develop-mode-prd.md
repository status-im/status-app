...
| 0010 status-go full-pin | branch pushed, app manifest → `URL#hash`, submodule removed, store-scratch Go build, stamp-skip vs FORCE arms | open (unblocked) |
| 0011 keycard pair | FetchContent pins + `FETCHCONTENT_SOURCE_DIR` develop redirect | open (unblocked) |
